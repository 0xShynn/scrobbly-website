  ...
  return (
    <LayoutPage>
      <SEO
        ...
        description="Terms and conditions for the Scrobbly iOS mobile application."
      />
      ...
      <section>
        <p>
          ...
          related to it, still belong to Antonin Nhek.
        </p>{" "}
        <p>
          Antonin Nhek is committed to ensuring that the app is as useful and
        ...
        <p>
          The Scrobbly app stores and processes personal data that you have
          ...
          Scrobbly app won’t work properly or at all.
        </p>{" "}
        <p>
        ...
        <p>
          Links to Terms and Conditions of third party service providers used by
          the app :
        </p>{" "}
        <ul>
          <li>
        ...
        <p>
          You should be aware that there are certain things that Antonin Nhek
          ...
          can be Wi-Fi, or provided by your mobile network provider, but Antonin
          Nhek cannot take responsibility for the app not working at full
        ...
        <p>
          Along the same lines, Antonin Nhek cannot always take responsibility
          ...
          on to avail the Service, Antonin Nhek cannot accept responsibility.
        </p>{" "}
        <p>
          With respect to Antonin Nhek’s responsibility for your use of the app,
          ...
          that we can make it available to you. Antonin Nhek accepts no
        ...
        <p>
          ...
          using the app. Antonin Nhek does not promise that it will always
        ...
        <p>These terms and conditions are effective as of 2021-02-03</p>{" "}
        <h2>Contact Us</h2>
        <p>
